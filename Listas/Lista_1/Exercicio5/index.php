...
<body class="container">
    ...
    <form method="POST" action="resultado.php">
        <div class="row">
            <div class="col">
                <label for="valor" class="label-control">Informe a primeira nota: </label>
            ...
            <div class="col">
                <label for="nota4" class="label-control">Informe a quarta nota: </label>
                <input type="number" name="nota4" id="nota4" class="form-control" />
            </div>
            <div class="row mt-5">
                <div class="col">
                    <button type="submit" class="btn btn-success">Calcular notas</button>
                </div>
            </div>
        </div>
    </form>
